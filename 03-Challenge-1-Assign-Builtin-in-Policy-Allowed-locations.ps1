...
A script used to assign the Built-in Allowed location policy to your resource group.
...
Filename:       03-Challenge-1-Assign-Builtin-in-Policy-Allowed-locations.ps1
Created:        04/03/2026
...
.\03-Challenge-1-Assign-Builtin-in-Policy-Allowed-locations.ps1
...
$policyName = $inventoryNumbering.ToString("D2") + "-" + "restrict-to-sovereign-regions"
$policyDisplayName = $rgLabUser03Name + "-" + "Restrict to Sovereign Regions"
